...
import (
	...
	zerodayzv1alpha1 "github.com/zerodayz/busybox-operator/pkg/apis/zerodayz/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &zerodayzv1alpha1.Busybox{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &zerodayzv1alpha1.Busybox{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileBusybox) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &zerodayzv1alpha1.Busybox{}
...
func newPodForCR(cr *zerodayzv1alpha1.Busybox) *corev1.Pod {
